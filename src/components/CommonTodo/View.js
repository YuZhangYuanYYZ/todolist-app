...
class View extends React.Component {
   ...
   // style={snapshot.isDragging,
    ...
    >
    {
     <li key={this.props.todo.id} data-index={this.props.index} onDoubleClick={()=>this.sidbarTogle(this.props.todo.id)} className={this.convertDataToClassName(this.props.todo)}>{this.props.todo.text} 
