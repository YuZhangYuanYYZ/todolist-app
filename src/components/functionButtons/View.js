    ...
    render() {
        return (
            <div className="buttons" >
                <button className="remove" onClick={this.removeHandeler} >
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                        viewBox="0 0 22 22" style={{ enablebackground: "new 0 0 22 22" }} xml space="preserve">
                ...
                <button className="complete" onClick={this.completeHandeler} >
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 22 22" style={{ enablebackground: "new 0 0 22 2" }} xml space="preserve">
